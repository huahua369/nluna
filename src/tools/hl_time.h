...
#define ARDRONE_DEFAULT_DATE        "19700101_000000"
	...
	*/
	...
	public:
...
#if 1
		int64_t getDate() //从 Date 对象返回一个月中的某一天 (1 ~ 31)。
		{
			return _p.tm_mday;
		}
		int64_t getWDay() //从 Date 对象返回一周中的某一天 (0 ~ 6)。
		{
			return _p.tm_wday;
		}
		int64_t getMonth() //从 Date 对象返回月份 (0 ~ 11)。
		{
			return _p.tm_mon;
		}
		int64_t getFullYear() //从 Date 对象以四位数字返回年份。
		{
			return _p.tm_year + 1900;
		}
		int64_t getYear() //请使用 getFullYear( ) 方法代替。
		{
			return _p.tm_year;
		}
		int64_t getHours() //返回 Date 对象的小时 (0 ~ 23)。
		{
			return _p.tm_hour;
		}
		int64_t getMinutes() //返回 Date 对象的分钟 (0 ~ 59)。
		{
			return _p.tm_min;
		}
		int64_t getSeconds() //返回 Date 对象的秒数 (0 ~ 59)。
		{
			return _p.tm_sec;
		}
		int64_t getMilliseconds() //返回 Date 对象的毫秒(0 ~ 999)。
		{
			return std::max(_t % 1000, _milliseconds);
		}
		int64_t getTime() //返回 1970 年 1 月 1 日至今的毫秒数。
		{
			return _t;
		}
		int64_t getTimezoneOffset() //返回本地时间与格林威治标准时间 (GMT) 的分钟差。
		{
			return 0;
		}
		int64_t getUTCDate() //根据世界时从 Date 对象返回月中的一天 (1 ~ 31)。
		{
			return 0;
		}
		int64_t getUTCDay() //根据世界时从 Date 对象返回周中的一天 (0 ~ 6)。
		{
			return 0;
		}
		int64_t getUTCMonth() //根据世界时从 Date 对象返回月份 (0 ~ 11)。
		{
			return 0;
		}
		int64_t getUTCFullYear() //根据世界时从 Date 对象返回四位数的年份。
		{
			return 0;
		}
		int64_t getUTCHours() //根据世界时返回 Date 对象的小时 (0 ~ 23)。
		{
			return 0;
		}
		int64_t getUTCMinutes() //根据世界时返回 Date 对象的分钟 (0 ~ 59)。
		{
			return 0;
		}
		int64_t getUTCSeconds() //根据世界时返回 Date 对象的秒钟 (0 ~ 59)。
		{
			return 0;
		}
		int64_t getUTCMilliseconds() //根据世界时返回 Date 对象的毫秒(0 ~ 999)。
		{
			return 0;
		}
		...
		int64_t setDay(int64_t s, bool ism = true) //设置 Date 对象中月的某一天 (1 ~ 31)。
		{
		...
		int64_t incDay(int64_t s, bool ism = true) //设置 Date 对象中月的某一天 (1 ~ 31)。
		{
		...
		int64_t setMonth(int64_t s, bool ism = true) //设置 Date 对象中月份 (0 ~ 11)。
		{
		...
		int64_t setFullYear(int64_t s, bool ism = true) //设置 Date 对象中的年份（四位数字）。
		{
			_p.tm_year = s - 1900;
			if (ism)make();
			return 0;
		}
		int64_t setYear(int64_t s, bool ism = true) //请使用 setFullYear( ) 方法代替。
		{
			_p.tm_year = s;
			if (ism)make();
			return 0;
		}
		int64_t setHours(int64_t s) //设置 Date 对象中的小时 (0 ~ 23)。
		{
			_p.tm_hour = s; make();
			return 0;
		}
		int64_t setMinutes(int64_t s) //设置 Date 对象中的分钟 (0 ~ 59)。
		{
			_p.tm_min = s; make();
			return 0;
		}
		int64_t setSeconds(int64_t s) //设置 Date 对象中的秒钟 (0 ~ 59)。
		{
			_p.tm_sec = s; make();
			return 0;
		}
		int64_t setMilliseconds(int64_t s) //设置 Date 对象中的毫秒 (0 ~ 999)。
		{
			_milliseconds = s;
			return 0;
		}
		int64_t setTime(int64_t s) //以毫秒设置 Date 对象。
		{
			set(s);
			return 0;
		}
		int64_t setUTCDate(int64_t s) //根据世界时设置 Date 对象中月份的一天 (1 ~ 31)。
		{
			return 0;
		}
		int64_t setUTCMonth(int64_t s) //根据世界时设置 Date 对象中的月份 (0 ~ 11)。
		{
			return 0;
		}
		int64_t setUTCFullYear(int64_t s) //根据世界时设置 Date 对象中的年份（四位数字）。
		{
			return 0;
		}
		int64_t setUTCHours(int64_t s) //根据世界时设置 Date 对象中的小时 (0 ~ 23)。
		{
			return 0;
		}
		int64_t setUTCMinutes(int64_t s) //根据世界时设置 Date 对象中的分钟 (0 ~ 59)。
		{
			return 0;
		}
		int64_t setUTCSeconds(int64_t s) //根据世界时设置 Date 对象中的秒钟 (0 ~ 59)。
		{
			return 0;
		}
		int64_t setUTCMilliseconds(int64_t s) //根据世界时设置 Date 对象中的毫秒 (0 ~ 999)。
		{
			return 0;
		}
