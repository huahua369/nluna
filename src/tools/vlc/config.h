...
#define FFMPEG_CONFIGURATION "--prefix=./buildout --enable-shared --disable-debug --disable-static --enable-gpl --enable-version3 --enable-sdl --enable-vulkan --enable-d3d11va --enable-dxva2 --enable-libsrt --enable-libx264 --enable-libx265 --enable-ffmpeg --enable-ffplay --enable-ffprobe"
...
#define CC_IDENT "gcc 12.2.0 (Rev1, Built by MSYS2 project)"
